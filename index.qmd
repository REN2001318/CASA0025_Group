...
This application is built for local coastal wetland managers, conservation planners, natural resources agencies, and environmental NGOs in Lianyungang, China. It helps these users preliminarily identify priority areas for protection or restoration across long coastlines before committing to costly field surveys. With this app, they’re able to rapidly narrow down candidate sites where tidal-flat loss, potential resting-place degradation, or coastal squeeze risk may be highest. 
