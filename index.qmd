...
![Figure1. Total Workflow](images/Group_4.svg){width="80%"}
:::

![Figure1. Total Workflow](images/Group_4.svg){width="80%" fig-align="center"}



![Figure3. Tidal Flat Workflow](images/Group_2_2.svg){width="80%" fig-align="center"}
...
![Figure2. Tidal Flat Workflow](images/Group_1.svg){width="80%" fig-align="center"}
...
![Figure2. Roost Workflow](images/workflow_roost_2.svg){width="60%" fig-align="center"}

![Figure6. Tidal Flat Workflow](images/Group_3.svg){width="83%" fig-align="center"}
...
Large tidal-flat patches exceed GEE's connectedPixelCount size limit, preventing reliable area-based filtering. These were removed in QGIS where vector-based area calculation has no such constraint. The cleaned raster was re-uploaded for post-processing below.
...
The final output is a spatial proxy. Limitations include reliance on a single composite period, cross-validation only (no field-validated roost data), and manual tidal-flat removal. Target users such as coastal management agencies typically hold authoritative land-use inventories that could replace the manual removal step with automated vector masking. The map is consumed by the interactive application as a static 2024 layer.
